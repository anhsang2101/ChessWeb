...
// 2. back-end
// - handle authentication: processing...
...
function HomePage() {
  ...
  //   if(option === "playingOnline") {
  //     rightSideConRef.current.innerHTML = <TimeOptions/>
  //   }
  //   // socket.emit(option);
  // }
    ...
    <div className="container">
      ...
      {/* <div className="side_bar">
        ...
        <a className="side_bar-link" href="/review">
          <span className="rounded"><FontAwesomeIcon icon={faStar} /></span>
        ...
        <a className="side_bar-link button sign_up" href="/signup">Sign Up</a>
        <a className="side_bar-link button log_in" href="/login">Log In</a>
      </div> */}

      <BoardDefault controllerSide={<PlayingOptions/>}/>
      {/* <BoardDefault controllerSide={<HistoriesAndChats/>}/> */}
      {/* <div className="right_side_container">
        ...
        <div className="playing_options" ref={rightSideConRef}>
